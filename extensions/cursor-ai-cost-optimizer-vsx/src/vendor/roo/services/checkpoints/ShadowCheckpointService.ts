// Vendored from Roo Code (src/services/checkpoints/ShadowCheckpointService.ts), Apache-2.0, see ../../LICENSE. Unmodified;
// simple-git is pinned to the 3.27 line Roo Code uses (later lines refuse the --template flag and GIT_EDITOR).
